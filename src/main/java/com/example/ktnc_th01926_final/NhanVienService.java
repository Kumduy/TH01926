...
public class NhanVienService {
    ...
    public NhanVienService(){
        list.add(new NhanVien("NV1", "Trần Anh Duy", 18, 200f, 3,"IT"));
        list.add(new NhanVien("NV2", "Trần Anh Duy", 18, 200f, 3,"IT"));
        list.add(new NhanVien("NV3", "Trần Anh Duy", 18, 200f, 3,"IT"));
    }
